...
router.patch('/:id', (0, auth_1.default)(userConstant_1.USER_ROLE.user, userConstant_1.USER_ROLE.admin), blogController_1.blogControllers.updateBlog);
router.delete('/:id', (0, auth_1.default)(userConstant_1.USER_ROLE.user, userConstant_1.USER_ROLE.admin), blogController_1.blogControllers.deleteBlog);
